...
TRANSLATIONS = {
    "pl": {
        ...
        "toast_category": "Wylosowano przypadek z kategorii: {}",
        "kpi_overall": "Ogółem",
        "kpi_cases": "Przypadki",
        "kpi_avg": "Średnia",
        "kpi_prev": "Poprzednia dziedzina",
        "kpi_next": "Następna dziedzina",
        "kpi_best": "🏆 Najlepszy",
        "kpi_worst": "📉 Najgorszy",
        "kpi_toggle": "Zmień na Najgorszy/Najlepszy",
        "tab_trend": "📈 Trend wyników",
        "tab_avg_cat": "📊 Średnia wg Kategorii",
        "tab_dist": "🥧 Udział dziedzin",
        "lbl_category": "Kategoria",
        "lbl_avg_score": "Średni wynik [%]",
        "lbl_cases_count": "Liczba przypadków",
        "filter_history": "Filtruj historię i mikro-statystyki:",
        "filter_all": "Wszystkie",
        "summary_all": "PODSUMOWANIE OGÓLNE (WSZYSTKIE DZIEDZINY)",
        "summary_cat": "PODSUMOWANIE:",
        "lbl_completed": "📝 Ukończono",
        "lbl_saved_score": "Zapisany wynik:",
        "cat_interna": "Interna",
        "cat_pedsy": "Pediatria",
        "cat_ratunkowa": "Ratunkowa",
        "cat_inne": "Inne",
        "cat_wlasne": "Własne",
    },
    "en": {
        ...
        "toast_category": "Case drawn from category: {}",
        "kpi_overall": "Overall",
        "kpi_cases": "Cases",
        "kpi_avg": "Average",
        "kpi_prev": "Previous category",
        "kpi_next": "Next category",
        "kpi_best": "🏆 Best",
        "kpi_worst": "📉 Worst",
        "kpi_toggle": "Toggle Worst/Best",
        "tab_trend": "📈 Score Trend",
        "tab_avg_cat": "📊 Avg by Category",
        "tab_dist": "🥧 Category Distribution",
        "lbl_category": "Category",
        "lbl_avg_score": "Average score [%]",
        "lbl_cases_count": "Number of cases",
        "filter_history": "Filter history and micro-stats:",
        "filter_all": "All",
        "summary_all": "OVERALL SUMMARY (ALL CATEGORIES)",
        "summary_cat": "SUMMARY:",
        "lbl_completed": "📝 Completed",
        "lbl_saved_score": "Saved score:",
        "cat_interna": "Internal Med",
        "cat_pedsy": "Pediatrics",
        "cat_ratunkowa": "Emergency",
        "cat_inne": "Other",
        "cat_wlasne": "Custom",
    }
}
